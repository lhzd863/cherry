...
import (
	...
	"github.com/lhzd863/cherry/src/pkg/config/parser"
	"github.com/lhzd863/cherry/src/pkg/html"
	"github.com/lhzd863/cherry/src/pkg/messageplexer"
	"github.com/lhzd863/cherry/src/pkg/reqtraps"
	"strconv"
	"strings"
	"syscall"
)
...
func getListenPeer(c *config.CherryRooms, port string) (net.Listener, error) {
	...
	if c.GetCertificatePath() != "" && c.GetPrivateKeyPath() != "" {
		...
		listenConn, listenError = net.Listen("tcp", ":"+port)
	}
